...
const KnowledgeBase = () => {
    return (
        <div>
            <div
                ...
                <div className="relative">
                    <div
                        ...
                        <div
                            className="mb-2 text-center text-2xl font-bold dark:text-white md:text-5xl">Knowledge Base</div>
                    </div>
            ...
            <div
                className="mt-10 flex flex-col-reverse items-center justify-between gap-5 rounded-md bg-gradient-to-tl from-[rgba(234,241,255,0.44)] to-[rgba(234,241,255,0.96)] px-6 py-2.5 dark:from-[rgba(14,23,38,0.44)] dark:to-[#0E1726] md:flex-row lg:mt-20 xl:px-16">
