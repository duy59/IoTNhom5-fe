...
<div className="w-full h-4 bg-[#ebedf2] dark:bg-dark/40 rounded-full">
    <div className="bg-gradient-to-r from-[#2b5876] to-[#4e4376] h-4 rounded-full w-9/12"></div>
                        ...
                        <div className="mb-5 space-y-5">
                            <div className="h-4 w-full rounded-full bg-[#ebedf2] dark:bg-dark/40">
                                <div
                                    className="h-4 w-3/12 rounded-full bg-gradient-to-r from-[#0081ff] to-[#0045ff]"></div>
                            </div>
                            <div className="h-4 w-full rounded-full bg-[#ebedf2] dark:bg-dark/40">
                                <div
                                    className="h-4 w-4/12 rounded-full bg-gradient-to-r from-[#04befe] to-[#4481eb]"></div>
                            </div>
                            <div className="h-4 w-full rounded-full bg-[#ebedf2] dark:bg-dark/40">
                                <div
                                    className="h-4 w-5/12 rounded-full bg-gradient-to-r from-[#3cba92] to-[#0ba360]"></div>
                            </div>
                            <div className="h-4 w-full rounded-full bg-[#ebedf2] dark:bg-dark/40">
                                <div
                                    className="h-4 w-6/12 rounded-full bg-gradient-to-r from-[#f09819] to-[#ff5858]"></div>
                            </div>
                            <div className="h-4 w-full rounded-full bg-[#ebedf2] dark:bg-dark/40">
                                <div
                                    className="h-4 w-7/12 rounded-full bg-gradient-to-r from-[#d09693] to-[#c71d6f]"></div>
                            </div>
                            <div className="h-4 w-full rounded-full bg-[#ebedf2] dark:bg-dark/40">
                                <div
                                    className="h-4 w-8/12 rounded-full bg-gradient-to-r from-[#7579ff] to-[#b224ef]"></div>
                            </div>
                            <div className="h-4 w-full rounded-full bg-[#ebedf2] dark:bg-dark/40">
                                <div
                                    className="h-4 w-9/12 rounded-full bg-gradient-to-r from-[#2b5876] to-[#4e4376]"></div>
                            </div>
                        </div>
                    </PanelCodeHighlight>
        ...
        <div className="bg-danger h-4 rounded-full w-11/12 text-center text-white flex justify-between items-center px-2 text-xs">
            ...
            <span>90%</span>
                        ...
                        <div className="mb-5 space-y-5">
                            ...
                            <div className="h-4 w-full rounded-full bg-[#ebedf2] dark:bg-dark/40">
                                <div
                                    className="flex h-4 w-11/12 items-center justify-between rounded-full bg-danger px-2 text-center text-xs text-white">
                                    <span>PHP</span>
                                    <span>90%</span>
                                </div>
                            </div>
                        ...
                        <div className="mb-5 space-y-5">
                            <div className="space-y-2">
                                ...
                                <div className="flex h-4 w-full rounded-full bg-[#ebedf2] dark:bg-dark/40">
                                    <div
                                        className="h-4 w-2/12 bg-success text-center text-xs text-white ltr:rounded-l-full rtl:rounded-r-full"></div>
                                    <div className="h-4 w-4/12 bg-warning text-center text-xs text-white"></div>
                                    <div
                                        className="h-4 w-3/12 bg-danger text-center text-xs text-white ltr:rounded-r-full rtl:rounded-l-full"></div>
                                </div>
                            </div>
                            <div className="space-y-2">
                                <h3 className="text-base">Striped</h3>
        ...
        <div className="bg-danger h-6 rounded-full rounded-bl-full w-10/12 text-center text-white text-xs"></div>
                        ...
                        <div className="mb-5 space-y-5">
                            <div className="space-y-1">
                                ...
                                <div className="flex h-4 w-full rounded-full bg-[#ebedf2] dark:bg-dark/40">
                                    <div
                                        className="h-4 w-3/12 rounded-full rounded-bl-full bg-primary text-center text-xs text-white"></div>
                                </div>
                            </div>
                            <div className="space-y-2">
                                <h3 className="text-base text-success">Progress-sm</h3>
                                <div className="flex h-1 w-full rounded-full bg-[#ebedf2] dark:bg-dark/40">
                                    <div
                                        className="h-1 w-5/12 rounded-full rounded-bl-full bg-success text-center text-xs text-white"></div>
                                </div>
                            </div>
                            <div className="space-y-2">
                                <h3 className="text-base text-warning">Progress-md</h3>
                                <div className="flex h-2.5 w-full rounded-full bg-[#ebedf2] dark:bg-dark/40">
                                    <div
                                        className="h-2.5 w-7/12 rounded-full rounded-bl-full bg-warning text-center text-xs text-white"></div>
                                </div>
                            </div>
                            <div className="space-y-2">
                                <h3 className="text-base text-info">Progress-lg</h3>
                                <div className="flex h-5 w-full rounded-full bg-[#ebedf2] dark:bg-dark/40">
                                    <div
                                        className="h-5 w-8/12 rounded-full rounded-bl-full bg-info text-center text-xs text-white"></div>
                                </div>
                            </div>
                            <div className="space-y-2">
                                <h3 className="text-base text-danger">Progress-xl</h3>
                                <div className="flex h-6 w-full rounded-full bg-[#ebedf2] dark:bg-dark/40">
                                    <div
                                        className="h-6 w-10/12 rounded-full rounded-bl-full bg-danger text-center text-xs text-white"></div>
                                </div>
                            </div>
                        </div>
                    </PanelCodeHighlight>
