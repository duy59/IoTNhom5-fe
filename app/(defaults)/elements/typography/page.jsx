            ...
            <div className="grid grid-cols-1 gap-6 pt-5 lg:grid-cols-2">
                <div className="panel">
                    ...
                    <div className="mb-5 flex items-center justify-center">
                        <div
                            className="w-full max-w-xs overflow-hidden rounded-md border border-white-dark/20 dark:border-[#191e3a]">
                            ...
                            <div
                                className="border-border-white-dark/20 border-t bg-dark-light p-4 dark:border-black dark:bg-[#191e3a]">
                ...
                <div className="panel">
                    ...
                    <div className="mb-5 flex items-center justify-center">
                        <div
                            className="prose w-full max-w-xs rounded-md border border-white-dark/20 p-5">
                ...
                <div className="panel">
                    ...
                    <div className="mb-5 flex items-center justify-center">
                        <div
                            className="w-full max-w-xs rounded-md border border-white-dark/20 p-5 text-white-dark">
                ...
                <div className="panel">
                    ...
                    <div className="mb-5 flex items-center justify-center">
                        <blockquote
                            ...
                            <small
                                className="block w-full text-xs not-italic text-[#777] before:relative before:-top-1 before:inline-block before:h-[1px] before:w-3 before:bg-[#777] before:opacity-50 ltr:before:mr-1 rtl:before:ml-1">
                ...
                <div className="panel">
                    ...
                    <div className="mb-5 flex items-center justify-center">
                        <blockquote
                            ...
                            <small
                                className="block w-full text-xs not-italic text-[#777] before:relative before:-top-1 before:inline-block before:h-[1px] before:w-3 before:bg-[#777] before:opacity-50 ltr:text-right ltr:before:mr-1 rtl:text-left rtl:before:ml-1">
                                Someone famous <cite className="italic">Source Title</cite>
                            </small>
                        </blockquote>
                    </div>
