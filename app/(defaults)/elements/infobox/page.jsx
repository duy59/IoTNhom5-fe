        ...
        <button type="button" className="text-primary font-semibold hover:underline group">
            ...
            <svg>...</svg>
                    ...
                    <div className="mb-5 flex w-full flex-wrap justify-center">
                        <div
                            className="rounded-md border border-gray-500/20 p-6 shadow-[rgb(31_45_61_/_10%)_0px_2px_10px_1px] dark:shadow-[0_2px_11px_0_rgb(6_8_24_/_39%)]">
                            ...
                            <button
                                ...
                                Discover{' '}
                                <IconArrowLeft
                                    className="relative inline-block transition-all duration-300 group-hover:translate-x-2 ltr:ml-1 rtl:mr-1 rtl:rotate-180 rtl:group-hover:-translate-x-2" />
                            </button>
                        </div>
                    </div>
                </PanelCodeHighlight>
    ...
    <div className="bg-dark border border-gray-500/20 rounded-md shadow-[rgb(31_45_61_/_10%)_0px_2px_10px_1px] dark:shadow-[0_2px_11px_0_rgb(6_8_24_/_39%)] p-6 text-center">
        ...
        <button type="button" className="text-info font-semibold hover:underline group">
            ...
            <svg>...</svg>
                    ...
                    <div className="mb-5 flex w-full flex-wrap justify-center">
                        <div
                            className="rounded-md border border-gray-500/20 bg-dark p-6 text-center shadow-[rgb(31_45_61_/_10%)_0px_2px_10px_1px] dark:shadow-[0_2px_11px_0_rgb(6_8_24_/_39%)]">
                            <div
                                className="bg1-white-dark mx-auto mb-5 flex h-20 w-20 items-center justify-center rounded-full text-white-light">
                                <IconBox className="h-12 w-12" />
                            </div>
    ...
    <div className="border border-gray-500/20 rounded-md shadow-[rgb(31_45_61_/_10%)_0px_2px_10px_1px] dark:shadow-[0_2px_11px_0_rgb(6_8_24_/_39%)] p-6 pt-12 mt-8 relative">
        ...
        <button type="button" className="text-primary font-semibold hover:underline group">
            ...
            <svg>...</svg>
                    ...
                    <div className="mb-5 flex w-full flex-wrap justify-center">
                        <div
                            className="relative mt-8 rounded-md border border-gray-500/20 p-6 pt-12 shadow-[rgb(31_45_61_/_10%)_0px_2px_10px_1px] dark:shadow-[0_2px_11px_0_rgb(6_8_24_/_39%)]">
                            <div
                                className="absolute -top-8 mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-md bg-primary text-white-light ltr:left-6 rtl:right-6">
                                <IconBox className="h-12 w-12" />
                            </div>
