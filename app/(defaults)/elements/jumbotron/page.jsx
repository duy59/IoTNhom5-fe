    ...
    <p className="lead">
        <button type="button" className="btn btn-dark">
            Learn more
                    ...
                    <div
                        className="prose mb-5 w-full max-w-full rounded bg-[#f1f2f3] px-4 py-9 dark:bg-[#1b2e4b] dark:text-white-light sm:px-8 sm:py-16">
                        <h2
                            className="mb-5 mt-4  text-center text-5xl text-dark dark:text-white-light">Hello, world!</h2>
        ...
        <small className="ltr:text-right rtl:text-left w-full not-italic text-xs text-[#777] block before:w-3 before:h-[1px] before:bg-[#777] before:inline-block before:opacity-50 before:relative before:-top-1 before:ltr:mr-1 rtl:before:ml-1">
            Someone famous <cite className="italic">Source Title</cite>
                    ...
                    <div
                        className="prose mb-5 w-full max-w-full rounded bg-[#f1f2f3] px-4 py-9 dark:bg-[#1b2e4b] dark:text-white-light sm:px-8 sm:py-16">
                        <h2
                            className="mb-5 mt-4  text-center text-5xl text-dark dark:text-white-light">Fluid Jumbotron</h2>
                        ...
                        <blockquote
                            ...
                            <small
                                className="block w-full text-xs not-italic text-[#777] before:relative before:-top-1 before:inline-block before:h-[1px] before:w-3 before:bg-[#777] before:opacity-50 ltr:text-right before:ltr:mr-1 rtl:text-left rtl:before:ml-1">
                                Someone famous <cite className="italic">Source Title</cite>
                            </small>
                        </blockquote>
                    </div>
