                ...
                >
                    ...
                    <div className="mb-5">
                        <div className="mx-auto max-w-[320px] md:max-w-[990px]">
                            <div
                                className="justify-between space-y-4 rtl:space-x-reverse md:flex md:space-x-4 md:space-y-0">
                                <div
                                    className="group rounded border border-black p-3 text-center hover:border-primary dark:border-[#1b2e4b] lg:p-5">
                                    <h3 className="text-xl lg:text-2xl">Beginner Savers</h3>
                                    <div
                                        className="mx-auto my-6 w-1/5 border-t border-black group-hover:border-primary dark:border-white-dark"></div>
                                    <p className="text-[15px]">For people who are starting out in the water saving business</p>
                                    <div className="my-7 p-2.5 text-center text-lg group-hover:text-primary">
                                        <strong
                                            className="text-3xl text-[#3b3f5c] group-hover:text-primary dark:text-white-dark lg:text-5xl">$19</strong> / monthly
                                    </div>
                                ...
                                <div
                                    ...
                                    <div className="my-7 p-2.5 text-center text-lg group-hover:text-primary">
                                        <strong
                                            className="text-3xl text-[#3b3f5c] group-hover:text-primary dark:text-white-dark lg:text-5xl">$29</strong> / monthly
                                    </div>
                                    <ul className="mb-5 space-y-2.5 font-semibold group-hover:text-primary">
                                        <li className="flex items-center justify-center">
                                            <IconArrowLeft className="h-3.5 w-3.5 shrink-0 ltr:mr-1 rtl:ml-1 rtl:rotate-180" />
                                ...
                                <div
                                    ...
                                    <div className="my-7 p-2.5 text-center text-lg group-hover:text-primary">
                                        <strong
                                            className="text-3xl text-[#3b3f5c] group-hover:text-primary dark:text-white-dark lg:text-5xl">$79</strong> / monthly
                                    </div>
                                    <ul className="mb-5 space-y-2.5 font-semibold group-hover:text-primary">
                                        <li className="flex items-center justify-center">
                                            <IconArrowLeft className="h-3.5 w-3.5 shrink-0 ltr:mr-1 rtl:ml-1 rtl:rotate-180" />
                ...
                <div className="p-5">
                    ...
                    <div className="mb-5">
                        <div className="mx-auto mt-20 max-w-[1140px] dark:text-white-dark">
                            <div
                                className="justify-between space-y-14 rtl:space-x-reverse md:flex md:space-x-4 md:space-y-0">
                                <div
                                    className="group rounded border border-white-light transition-all duration-300 dark:border-[#1b2e4b]">
                                    <div className="border-b border-white-light p-5 pt-0 dark:border-[#1b2e4b]">
                                        <span
                                            className="-mt-[30px] flex h-[70px] w-[70px] items-center justify-center rounded border-2 border-primary bg-white text-xl font-bold text-[#3b3f5c] shadow-[0_0_15px_1px_rgba(113,106,202,0.20)] transition-all duration-300 group-hover:-translate-y-[10px] dark:bg-black dark:text-white-light lg:h-[100px] lg:w-[100px] lg:text-3xl">
                                            $49
                                        </span>
