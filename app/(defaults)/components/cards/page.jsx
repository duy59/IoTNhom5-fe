        ...
        <div className="py-7 px-6">
            ...
            <p className="text-white-dark">Mauris nisi felis, placerat in volutpat id, varius et sapien.</p>
                    ...
                    <div className="mb-5 flex items-center justify-center">
                        <div
                            className="w-full max-w-[19rem] rounded border border-white-light bg-white shadow-[4px_6px_10px_-3px_#bfc9d4] dark:border-[#1b2e4b] dark:bg-[#191e3a] dark:shadow-none">
                            <div className="px-6 py-7">
                                <div
                                    className="mb-5 inline-block rounded-full bg-[#3b3f5c] p-3 text-[#f1f2f3]">
                                    <IconDroplet />
                                </div>
                                <h5
                                    className="mb-4 text-xl font-semibold text-[#3b3f5c] dark:text-white-light">Simple</h5>
                                <p className="text-white-dark">Mauris nisi felis, placerat in volutpat id, varius et sapien.</p>
                            </div>
                        </div>
                    </div>
                ...
                Explore More
                    ...
                    <div className="mb-5 flex items-center justify-center">
                        <div
                            ...
                            <div className="px-6 py-7">
                                <div
                                    className="-mx-6 -mt-7 mb-7 h-[215px] overflow-hidden rounded-tl rounded-tr">
                                    <img
                                ...
                                <h5
                                    className="mb-4 text-xl font-semibold text-[#3b3f5c] dark:text-white-light">CLI Based</h5>
                                <p className="text-white-dark">Etiam sed augue ac justo tincidunt posuere. Vivamus euismod eros, nec risus malesuada.</p>
                                <button type="button" className="btn btn-primary mt-6">
                                    Explore More
                                </button>
    ...
    <div className="max-w-[18rem] w-full bg-[#3b3f5c] shadow-[4px_6px_10px_-3px_#bfc9d4] rounded border border-white-light dark:border-[#1b2e4b] dark:bg-[#191e3a] dark:shadow-none p-5">
        <div className="text-center text-black-light">
            ...
            <p className="font-semibold italic">Maecenas nec mi vel lacus condimentum rhoncus dignissim egestas orci. Integer blandit porta placerat. Vestibulum in ultricies.</p>
                    ...
                    <div className="mb-5 flex items-center justify-center">
                        <div
                            className="w-full max-w-[18rem] rounded border border-white-light bg-[#3b3f5c] p-5 shadow-[4px_6px_10px_-3px_#bfc9d4] dark:border-[#1b2e4b] dark:bg-[#191e3a] dark:shadow-none">
                            <div className="text-center text-black-light">
        ...
        <div className="p-5 flex items-center flex-col sm:flex-row">
            ...
            <div className="flex-1 ltr:sm:pl-5 rtl:sm:pr-5 text-center sm:text-left">
                ...
                <p className="font-semibold text-white-dark mt-4 sm:mt-8">
                    ...
                    <div className="mb-5 flex items-center justify-center">
                        <div
                            className="w-full max-w-[30rem] rounded border border-white-light bg-white shadow-[4px_6px_10px_-3px_#bfc9d4] dark:border-[#1b2e4b] dark:bg-[#191e3a] dark:shadow-none">
                            <div className="flex flex-col items-center p-5 sm:flex-row">
                                ...
                                <div className="flex-1 text-center sm:text-left ltr:sm:pl-5 rtl:sm:pr-5">
                                    <h5
                                        className="mb-2 text-[15px] font-semibold text-[#3b3f5c] dark:text-white-light">Luke Ivory</h5>
                                    <p className="mb-2 text-white-dark">Manager</p>
        ...
        <div className="text-black-light">
            ...
            <div className="flex">
                ...
                <div className="flex-1 ltr:pl-4 rtl:pr-4">
                    ...
                    <div className="mb-5 flex items-center justify-center">
                        <div
                            className="w-full max-w-[20rem] rounded border border-white-light bg-secondary p-5 shadow-[4px_6px_10px_-3px_#bfc9d4] dark:border-0 dark:bg-secondary-dark-light dark:shadow-none">
                            <div className="text-black-light">
        ...
        <div className="text-[#515365] dark:text-white-light">
            ...
            <div className="flex">
                <div className="flex-1">
                    ...
                    <div className="mb-5 flex items-center justify-center">
                        <div
                            className="w-full max-w-[20rem] rounded border border-white-light bg-white p-5 shadow-[4px_6px_10px_-3px_#bfc9d4] dark:border-[#1b2e4b] dark:bg-[#191e3a] dark:shadow-none ">
                            <div className="text-[#515365] dark:text-white-light">
                                ...
                                <div className="flex">
                                    <div className="flex-1">
                                        <h5
                                            className="mb-1.5 text-[15px] font-bold text-[#3b3f5c] dark:text-white-light">Luke Ivory</h5>
        ...
        <div className="text-center font-semibold">
            ...
            <div className="flex justify-center items-center gap-1 text-[#e2a03f]">
                ...
                <span className="text-white ltr:ml-1 rtl:mr-1">(94)</span>
                    ...
                    <div className="mb-5 flex items-center justify-center">
                        <div
                            className="w-full max-w-[20rem] rounded border border-white-light bg-primary p-5 shadow-[4px_6px_10px_-3px_#bfc9d4] dark:border-0 dark:bg-primary-dark-light dark:shadow-none">
                            <div className="text-center font-semibold">
        ...
        <div className="text-right">
            ...
            <div className="bg-[#ebedf2] dark:bg-black rounded-full w-full h-1.5 mt-1.5">
                <div className="rounded-full bg-primary h-full" style={{ width: '60%' }}></div>
                    ...
                    <div className="mb-5 flex items-center justify-center">
                        <div
                            className="w-full max-w-[24rem] rounded border border-white-light bg-white p-5 shadow-[4px_6px_10px_-3px_#bfc9d4] dark:border-[#1b2e4b] dark:bg-[#191e3a] dark:shadow-none">
                            <div className="mb-5 flex justify-between">
                                <h6 className="text-base font-semibold text-black dark:text-white-light">Placed Order</h6>
                                <span
                                    className="badge bg-primary/10 py-1.5 text-primary dark:bg-primary dark:text-white">IN PROGRESS</span>
                            </div>
                            <div
                                className="mb-5 flex items-center justify-start -space-x-3 rtl:space-x-reverse">
                                <img
                                ...
                                <img
                                    ...
                                    alt="profile" />
                                <span
                                    className="rounded-full bg-white px-2 py-1 text-xs text-primary shadow-[0_0_20px_0_#d0d0d0] dark:bg-black dark:text-white dark:shadow-none">+5 more</span>
                            </div>
                            <div className="text-right">
        ...
        <div className="py-7 px-6">
            ...
            <div className="relative flex justify-between mt-6 pt-4 before:w-[250px] before:h-[1px] before:bg-white-light before:inset-x-0 before:top-0 before:absolute before:mx-auto dark:before:bg-[#1b2e4b]">
                ...
                <div className="flex font-semibold">
                    ...
                    <div className="mb-5 flex items-center justify-center">
                        <div
                            className="w-full max-w-[22rem] rounded border border-white-light bg-white shadow-[4px_6px_10px_-3px_#bfc9d4] dark:border-[#1b2e4b] dark:bg-[#191e3a] dark:shadow-none">
                            <div className="px-6 py-7">
                                <div
                                    className="-mx-6 -mt-7 mb-7 h-[260px] overflow-hidden rounded-tl rounded-tr">
                                    <img
                                        src="/assets/images/profile-28.jpeg"
                                        alt="profile"
                                        className="h-full w-full object-cover" />
                                ...
                                <h5
                                    className="mb-4 text-[15px] font-bold text-[#3b3f5c] dark:text-white-light">How to Start a Blog in 5 Easy Steps.</h5>
                                <p className="text-white-dark ">Vestibulum vestibulum tortor ut eros tincidunt, ut rutrum elit volutpat.</p>
                                <div
                                    className="relative mt-6 flex justify-between pt-4 before:absolute before:inset-x-0 before:top-0 before:mx-auto before:h-[1px] before:w-[250px] before:bg-white-light dark:before:bg-[#1b2e4b]">
                                    <div className="flex items-center font-semibold">
                                        <div
                                            className="inline-block h-9 w-9 shrink-0 overflow-hidden rounded-full ltr:mr-2 rtl:ml-2.5">
                                            <span
                                                className="flex h-full w-full items-center justify-center bg-[#515365] text-white-light">AG</span>
                                        </div>
                                        <div className="text-[#515365] dark:text-white-dark">Luke Ivory</div>
                                    </div>
                                    <div className="flex font-semibold">
